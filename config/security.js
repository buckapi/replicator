...
cors: {
  allRoutes: true, // Permitir todas las rutas para manejar solicitudes CORS.
  allowOrigins: '*', // Permitir todas las fuentes. Utiliza con precaución, solo para desarrollo o si estás seguro de lo que estás haciendo.
  allowCredentials: false, // Si necesitas enviar cookies o información de autenticación, pon esto en true.
  allowRequestMethods: 'GET, POST, PUT, DELETE, OPTIONS, HEAD', // Métodos permitidos.
  allowRequestHeaders: 'content-type, authorization' // Cabeceras permitidas.
}
  /***************************************************************************
  *                                                                          *
